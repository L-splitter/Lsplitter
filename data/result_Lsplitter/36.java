...
/** 
 * Validates the nodes and edges in the network.
 * @param network The network to validate.
 * @param < N > The type of nodes in the network.
 * @param < E > The type of edges in the network.
 */
private static <N,E>void validateNetwork(Network<N,E> network){
  String networkString=network.toString();
...
/** 
 * Validates the degrees and connections of a node in the network.
 * @param network The network to validate.
 * @param node The node to validate.
 * @param < N > The type of nodes in the network.
 * @param < E > The type of edges in the network.
 */
private static <N,E>void validateNode(Network<N,E> network,N node){
