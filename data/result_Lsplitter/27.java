...
protected final void assertInvariants(Map<K, V> map) {
  ...
  assertInvariants(map, keySet, valueCollection);
...
/** 
 * Asserts the invariants of the key set and the value collection.
 * @param map the map to check
 * @param keySet the key set to check
 * @param valueCollection the value collection to check
 */
private void assertInvariants(Map<K,V> map, Set<K> keySet, Collection<V> valueCollection){
