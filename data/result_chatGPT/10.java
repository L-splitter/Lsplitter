/**
 * This method checks if the next token is a start object.
...
/**
 * This method processes the value token.
 * @param parser The parser to process.
 * @param currentFieldName The current field name.
 * @param doSection The do section to set.
 * @throws IOException If an I/O error occurs.
 */
private static void processValueToken(XContentParser parser, String currentFieldName, DoSection doSection) throws IOException {
...
private static void processApiCallSection(XContentParser parser, String currentFieldName, ApiCallSection apiCallSection) throws IOException {
    ...
    while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
        if (token == XContentParser.Token.FIELD_NAME) {
            ...
            processApiCallSectionStartObject(parser, paramName, apiCallSection);
        }
    }
}
/**
...
/**
 * This method processes the API call section start object.
 * @param parser The parser to process.
 * @param paramName The parameter name.
 * @param apiCallSection The API call section.
 * @throws IOException If an I/O error occurs.
 */
private static void processApiCallSectionStartObject(XContentParser parser, String paramName, ApiCallSection apiCallSection) throws IOException {
    if ("body".equals(paramName)) {
...
public static DoSection parse(XContentParser parser) throws IOException {
    ...
    while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
        if (token == XContentParser.Token.FIELD_NAME) {
            ...
            processValueToken(parser, currentFieldName, doSection);
