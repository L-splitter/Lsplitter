...
public void testAtSpaceBoundaries() throws CodeUnitInsertionException, IOException {
    testUndefinedWithAddr();
    testNullManager();
    testTraceInstruction();
    testTraceData();
    testUndefinedData();
    testCodeUnits();
...
/**
 * This method tests undefined addresses.
 */
private void testUndefinedWithAddr() {
...
/**
 * This method tests null manager.
 */
private void testNullManager() {
...
/**
 * This method tests trace instruction.
 * @throws CodeUnitInsertionException if there is an error inserting a code unit.
 */
private void testTraceInstruction() throws CodeUnitInsertionException {
...
/**
 * This method tests trace data.
 * @throws CodeUnitInsertionException if there is an error inserting a code unit.
 */
private void testTraceData() throws CodeUnitInsertionException {
    TraceData dDataMin;
    try (Transaction tx = b.startTransaction()) {
