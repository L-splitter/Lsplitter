...
/**
 * This method tests the rollback transaction.
 */
private void testRollbackTransaction() {
    // Test rollback (non-committed) transaction
    int txId1 = obj1.startTransaction("Test1");
    try {
        performTransaction(txId1, false);
    }
    finally {
...
/**
 * This method tests the committed transaction.
 */
private void testCommittedTransaction() {
    // Test committed transaction
    int txId1 = obj1.startTransaction("Test1");
    try {
        performTransaction(txId1, true);
    }
    finally {
