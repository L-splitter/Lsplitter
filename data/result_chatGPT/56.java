...
/**
 * This method is used to handle the thunked function.
 * @param callingConvention The calling convention of the function.
 * @param returnVar The return variable of the function.
 * @param newParams The new parameters of the function.
 * @param updateType The update type of the function.
 ...
 * @param source The source of the function.
 */
private void handleThunkedFunction(String callingConvention, Variable returnVar,
		List<? extends Variable> newParams, FunctionUpdateType updateType, boolean force,
		SourceType source) {
...
/**
 * This method is used to handle the calling convention.
 * @param callingConvention The calling convention of the function.
 */
private void handleCallingConvention(String callingConvention) {
	if (callingConvention != null) {
		setCallingConvention(callingConvention);
	}
}
/**
 * This method is used to handle the return variable.
 * @param returnVar The return variable of the function.
 */
private void handleReturnVar(Variable returnVar) {
	if (returnVar == null) {
