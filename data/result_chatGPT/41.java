/**
 * This method checks if the process is cancelled.
 */
...
/**
 * This method checks if the process is active and subscribes the inner publisher.
 */
private void checkIfActiveAndSubscribe(Publisher<? extends R> p) {
    if (active) {
        p.subscribe(inner);
    }
}
/**
 * This method checks if the process is decremented and gets to zero.
 */
private void checkIfDecrementAndGetToZero() {
...
public void run() {
    ...
    checkIfActiveAndSubscribe(p);
    checkIfDecrementAndGetToZero();
}
