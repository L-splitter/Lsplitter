...
public void testOperandFieldOptions() throws Exception {
    ...
    NamespaceWrappedOption namespaceOption = getNamespaceWrappedOption(options, names);
    verifyWordWrappingOption(options, names);
    verifyStackVariableMarkupOptions(options, names);
    verifyRegisterVariableMarkupOptions(options, names);
    verifyBlockNamesOption(options, names);
    verifyNamespaceOption(options, names, namespaceOption);
}
/**
...
/**
 * Gets the namespace wrapped option.
 * @param options the options.
 * @param names the list of option names.
 * @return the namespace wrapped option.
 */
private NamespaceWrappedOption getNamespaceWrappedOption(Options options, List<String> names) {
    return (NamespaceWrappedOption) options.getCustomOption(names.get(3), new NamespaceWrappedOption());
}
/**
...
/**
 * Verifies the stack variable markup options.
 * @param options the options.
 * @param names the list of option names.
 */
private void verifyStackVariableMarkupOptions(Options options, List<String> names) throws Exception {
...
/**
 * Verifies the register variable markup options.
 * @param options the options.
 * @param names the list of option names.
 */
private void verifyRegisterVariableMarkupOptions(Options options, List<String> names) throws Exception {
...
/**
 * Verifies the block names option.
 * @param options the options.
 * @param names the list of option names.
 */
private void verifyBlockNamesOption(Options options, List<String> names) throws Exception {
...
/**
 * Verifies the namespace option.
 * @param options the options.
 * @param names the list of option names.
 * @param namespaceOption the namespace option.
 */
private void verifyNamespaceOption(Options options, List<String> names, NamespaceWrappedOption namespaceOption) throws Exception {
