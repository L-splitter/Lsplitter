/**
 * This method creates the test index and sets the mapping.
 * @throws Exception
 */
private void createIndexAndSetMapping() throws Exception {
    assertAcked(
...
/**
 * This method prepares the search with the given field and sort order.
 * @param field The field to sort by.
 * @param sortOrder The order to sort by.
 * @return The search response.
 * @throws Exception
 */
private SearchResponse prepareSearch(String field, SortOrder sortOrder) throws Exception {
...
public void testSortMVField() throws Exception {
    ...
    prepareIndex(Integer.toString(3), jsonBuilder().startObject()
        ...
        .endObject());
    refresh();
    SearchResponse searchResponse = prepareSearch("long_values", SortOrder.ASC);
